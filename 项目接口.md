...
| flag     | int      | 项目状态：1:在建 2:停工  (app)                               |
| status   | int      | 项目状态：1：围护阶段；2：开挖阶段；3：结构阶段；4：结束阶段；5：已归档 （非必填） |
| pageNum  | int      | 分页 第几页  （非必填）                                      |
| pageSize | int      | 分页 每页条数 （非必填）                                     |
        ...
        "list": [
            {
                ...
                "freqCount": //频率  __次
        	    "progress"://报表进度 （监护项目） 
         		"reportNums": 0  //(监护项目  进度报表：reportNums/progress; 监测项目   进度报表： reportNums)
                "userList": null,
                "userNames": null,
                "userNum": null,
                "eqList": null, 
